...
from app.services.ai_hot_tracker_tracking_service import (
    run_ai_hot_tracker_tracking_run_execution,
    run_ai_hot_tracker_tracking_sweeper,
)
...
async def run_ai_hot_tracker_tracking_run(ctx: dict[str, object], run_id: str) -> dict[str, object]:
    return run_ai_hot_tracker_tracking_run_execution(run_id)
...
class WorkerSettings:
    functions = [
        run_platform_task,
        run_eval_run,
        run_research_analysis_run,
        run_ai_hot_tracker_tracking_run,
