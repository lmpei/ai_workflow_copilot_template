...
from app.schemas.mcp import LocalMcpResourceReadResult, McpResourceDefinition, McpServerDefinition
...
def build_research_context_local_mcp_server() -> ResearchContextLocalMcpServer:
    server = McpServerDefinition(
        ...
        summary="提供一个有边界的 Research 外部上下文资源，用来验证 MCP 资源接入、授权边界和后续可观测性。",
    ...
    resources = (
        McpResourceDefinition(
            ...
            summary="根据当前研究问题返回一份有边界的外部上下文摘要，作为后续 MCP 试点的资源基础。",
