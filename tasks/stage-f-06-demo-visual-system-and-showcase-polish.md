...
- improve layout hierarchy, spacing, typography, and visual emphasis on the highest-traffic user-facing pages
- remove obvious presentation defects such as visible encoding issues on live user-facing surfaces
- create a clearer showcase baseline without hiding the real product structure

Disallowed work:

- a full design-system rewrite across every page in the repository
- purely decorative motion or styling that does not improve comprehension
- backend or deployment changes unrelated to the user-facing visual surface
